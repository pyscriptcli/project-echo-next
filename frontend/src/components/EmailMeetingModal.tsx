    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[#001E3C]/50 p-4" role="dialog" aria-modal="true" aria-labelledby="email-meeting-title">
      <div className="w-full max-w-xl border border-slate-200 bg-[#FFFCFB] shadow-2xl">
        ...
        <div className="space-y-3 p-5">
          <div className="border border-[#C9AB4C]/50 bg-[#FAF9F7] px-3 py-2 text-[11px] text-slate-600"><b className="text-[#003366]">From:</b> {fromEmail || "ClickUp user email unavailable"}. <span className="block mt-0.5">Download the PDF first, then open the prefilled Outlook draft and attach it manually.</span></div>
