...
export function SignatureModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-lg bg-[#FFFCFB] rounded-none shadow-2xl border-2 border-[#003366] flex flex-col relative overflow-hidden">
        {/* Top Gold Accent Line */}
        <div className="h-[3px] bg-[#C9AB4C] w-full" />

        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-[#FFFCFB]">
          <div>
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-slate-400 hover:text-slate-600 hover:bg-[#FFFCFB] transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Tab Selection */}
        <div className="flex border-b border-slate-200 bg-[#FFFCFB]/60">
          <button
            type="button"
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${
              activeTab === "draw"
                ? "border-[#003366] text-[#003366] bg-[#FFFCFB]"
        ...
        <div className="p-6">
          {activeTab === "draw" ? (
            <div className="flex flex-col gap-3">
              <div className="relative border-2 border-dashed border-slate-300 rounded-none bg-[#FFFCFB] overflow-hidden select-none touch-none">
                <canvas
                  ref={canvasRef}
                  ...
                  className="w-full h-44 cursor-crosshair bg-[#FFFCFB]"
                />
            ...
            <div className="flex flex-col gap-4">
              {uploadedImage ? (
                <div className="relative border-2 border-slate-300 rounded-none p-4 bg-[#FFFCFB] flex items-center justify-center h-44">
                  <img
                    src={uploadedImage}
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-1 bg-[#FFFCFB] border border-slate-300 text-slate-500 hover:text-rose-600 cursor-pointer"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <label className="border-2 border-dashed border-slate-300 rounded-none h-44 flex flex-col items-center justify-center cursor-pointer hover:border-[#C9AB4C] hover:bg-[#003366]/5 transition-all">
                  <div className="p-3 bg-[#FFFCFB] text-[#003366] rounded-none mb-2">
        ...
        {/* Footer actions */}
        <div className="flex items-center justify-end gap-3 px-6 py-4 bg-[#FFFCFB] border-t border-slate-200">
          <button
            type="button"
            onClick={onClose}
